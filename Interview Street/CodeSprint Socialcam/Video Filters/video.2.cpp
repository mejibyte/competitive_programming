...
int main() {
    ...
    for (int i = 0; i < 300; ++i) {
        for (int j = 0; j < 300; ++j) {
            r[299 - i][299 - j] = read(offset++, 1);
            g[299 - i][299 - j] = read(offset++, 1);
            b[299 - i][299 - j] = read(offset++, 1);
        }
    }
    ...
    for (int i = 0; i < 300; ++i) {
           for (int j = 0; j < 300; ++j) {
               image[offset++] = nr[299 - i][299 - j];
               image[offset++] = ng[299 - i][299 - j];
               image[offset++] = nb[299 - i][299 - j];
