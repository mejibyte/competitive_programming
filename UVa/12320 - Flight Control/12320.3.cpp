...
int main(){
    int casos; scanf("%d", &casos); while (casos--) {
        ...
        times.resize(unique(times.begin(), times.end(), equalWithTolerance) - times.begin());
