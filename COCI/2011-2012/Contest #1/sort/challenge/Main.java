...
class TreapSet<K> implements NavigableSet<K> {
	...
	public MainedSet<K> subSet(K fromElement, K toElement) {
		return subSet(fromElement, true, toElement, false);
	}

	public MainedSet<K> headSet(K toElement) {
		return subSet(null, false, toElement, false);
	}

	public MainedSet<K> tailSet(K fromElement) {
